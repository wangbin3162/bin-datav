<template>
  <div class="bv-decoration-5" ref="domRef">
...
export default {
  ...
  setup(props) {
    const status = useBorderBox(props, ['#3f96a5', '#3f96a5'], calcSVGData)
    const data = reactive({
      line1Points: '',
      line2Points: '',
      line1Length: 0,
    ...
    function calcSVGData() {
      ...
      data.line1Points = line1Points
      data.line2Points = line2Points

      data.line1Length = line1Length
      data.line2Length = line2Length
    }
